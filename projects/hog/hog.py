...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    num_tens = opponent_score // 10 % 10
    num_ones = player_score % 10
    result = abs(num_tens - num_ones)*3
    if result < 1:
        return 1
    else:
        return result
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    def always_roll_strategy(score0, score1):
        return n
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if sus_update(0, score, opponent_score) >= GOAL:
        return 0
    if sus_strategy(score, opponent_score, threshold=11, num_rolls=6) == 0:
        return 0
